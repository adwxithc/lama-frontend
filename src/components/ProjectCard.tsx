...
function ProjectCard({project, colorClass}:{project:IProject, colorClass:string}) {
  ...
  return (
    <div className="rounded-2xl border border-black/30 shadow-xl h-32 p-2 overflow-hidden  flex cursor-pointer" onClick={()=>navigate(`/project/${project.id}`,{state:{name:project.name}})}>
